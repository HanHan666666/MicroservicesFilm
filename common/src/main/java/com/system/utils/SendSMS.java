...
public class SendSMS {
    ...
    public static com.aliyun.dysmsapi20170525.models.SendSmsResponse Send(String phone, String accessKeyId, String accessKeySecret, String code) throws Exception {
