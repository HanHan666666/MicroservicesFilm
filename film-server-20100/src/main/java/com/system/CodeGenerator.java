...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/film-server-20100/src/main/java");
        gc.setAuthor("wuhan");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/film-server-20100/src/main/resources/mapper/" + pc.getModuleName() + "/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
...
//        });
        ...
        // 列名转换方式
        strategy.setSuperEntityClass("com.system.base.BaseEntity");
        strategy.setEntityLombokModel(true); //lombok模型
        strategy.setRestControllerStyle(true); //restFul风格控制器
        // 公共父类
        strategy.setSuperControllerClass("com.system.base.BaseController")
        ;
        // 写于父类中的公共字段
