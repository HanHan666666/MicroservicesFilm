...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/order-server-30100/src/main/java");
        gc.setAuthor("Rye");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/sys_movie?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&useSSL=false&allowPublicKeyRetrieval=true");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/order-server-30100/src/main/resources/mapper/" + pc.getModuleName() + "/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
...
//        });
        ...
        strategy.setRestControllerStyle(true); //restFul风格控制器
        // 公共父类
